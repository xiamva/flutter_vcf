...
import 'qc_lab_cpo.dart';
import '../../login.dart';

class HomeLabCPOPage extends StatefulWidget {
  final String userId;
  final String token;
  const HomeLabCPOPage({super.key, required this.userId, required this.token});

  @override
  State<HomeLabCPOPage> createState() => _HomeLabCPOPageState();
}

class _HomeLabCPOPageState extends State<HomeLabCPOPage> {
  bool isLoading = true;
  String? errorMessage;
  ...
  Future<void> fetchStats() async {
    ...
    try {
      ...
      final res = await api.getQcLabCpoStatistics("Bearer $token");
        ...
        child: isLoading
            ...
            : errorMessage != null
                ...
                : Column(
                    ...
                    children: [
                      Text("Hai, QC Lab CPO 👋", style: Theme.of(context).textTheme.titleMedium),
